...
public class Buy extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "     promotion_id", "       customer_id", "      apartment_id", "    room_number", "     contract_id", "     receipt_id", "id"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Object.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Object.class, java.lang.Object.class
            };
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {
            ...
            while (rs.next()) {
                ...
                model.addRow(new String[]{promotion_id, customer_id, apartment_id, room_number, contract_id, receipt_id,iid});
            }
        } catch (Exception exc) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String apromotion_id = jTextField2.getText();
        String acustomer_id = jTextField3.getText();
        String aapartment_id = jTextField4.getText();
        String aroom_number = jTextField5.getText();
        String acontract_id = jTextField1.getText();
        String areceipt_id = jTextField6.getText();
        String id = jTextField7.getText();
        try {
            if (my.insertBuy(apromotion_id, acustomer_id, aapartment_id, aroom_number, acontract_id, areceipt_id,id)) {
                DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
                model.setRowCount(0);
                ResultSet rs = my.getData("Buy");
                while (rs.next()) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String areceipt_id = jTextField6.getText();
                String id = jTextField7.getText();
        try {
            if (my.updateBuy(apromotion_id, acustomer_id, aapartment_id, aroom_number, acontract_id, areceipt_id,id)) {
                DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
                model.setRowCount(0);
                ResultSet rs = my.getData("Buy");
                while (rs.next()) {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            model.setRowCount(0);
            ResultSet rs = my.getData("Buy where id="+"'"+id+"'");
            while (rs.next()) {
                String promotion_id = rs.getString("pro_id");
                String customer_id = rs.getString("cus_id");
                String apartment_id = rs.getString("apart_id");
